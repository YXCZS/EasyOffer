...
- [ ] 6.2 Start the backend and frontend build, import the generated `dist` into WeChat Developer Tools, and verify a normal question can be generated, answered, and reviewed while an asset transitions through pending/ready or failed fallback.
