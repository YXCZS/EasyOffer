...
- [ ] 4.4 Run the four flows in WeChat Developer Tools and record source metadata and first-question latency. The local IDE automation endpoint is not enabled, so this remains a manual verification item.
