...
- [ ] 9.4 Start the backend and built mini-program, then verify in WeChat Developer Tools that login, guest restrictions, topic generation, public-corpus generation, personal-document-only generation, incremental answering, unfinished-practice resume/delete, report review, and profile navigation remain usable.
