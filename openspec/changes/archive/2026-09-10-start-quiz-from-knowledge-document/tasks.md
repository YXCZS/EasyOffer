...
- [x] 4.3 在微信开发者工具验证已登录用户从 ready 文档点击“开始闯关”到生成、答题、保存进度和报告的完整链路，并验证 processing/failed、游客和跨用户请求均被阻止
- [x] 4.4 检查生成结果的 `evidence_meta` 与服务日志，确认专属练习全程没有 Tavily 请求且证据分片全部属于当前文档；记录验证结果作为变更交付说明
