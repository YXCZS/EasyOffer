...
- [ ] 7.5 In WeChat Developer Tools, manually verify normal public-knowledge generation, personal-only generation, guest generation, URL input, first-question release, continued background generation, answer progress save/resume, report generation, and image fallback; record any tool/IDE limitation instead of marking it passed
