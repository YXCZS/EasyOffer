...
from app.db import Base, models  # noqa: F401 - register all mappings
...
def run_migrations_offline() -> None:
    url = str(build_database_url(get_settings()))
...
async def run_async_migrations() -> None:
    ...
    configuration["sqlalchemy.url"] = str(build_database_url(settings))
